...
export default function Product() {
  ...
  const handleRadioFilterChanges = (e, sectionId) => {
    const searchParamms = new URLSearchParams(location.search);
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div>
                <div className="flex justify-between items-center">
                  <h1 className="texl-lg opacity-50  font-bold"> Filters </h1>
                        ...
                        <div className="space-y-4">
                          <FormControl>
                            ...
                            >
                              {section.options.map((option, optionIdx) => (
                                <FormControlLabel
                                  key={optionIdx} // Add a unique key here
                                  onChange={(e) =>
                                    handleRadioFilterChanges(e, section.id)
                                  }
                                  value={option.value}
                                  control={<Radio />}
                                  label={option.label}
              ...
              <div className="lg:col-span-4 w-full ">
                <div className="flex flex-wrap justify-center bg-white py-5">
                  ...
                  {products.products &&
                    products.products?.content?.map((item, key) => (
